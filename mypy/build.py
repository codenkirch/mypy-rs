...
class BuildManager:
    ...
    def __init__(
        ...
        from mypy.sharedparse import _set_native_sharedparse_active

        _set_native_sharedparse_active(self.options.native_type_kernel)
        ...
        # G2.2 (#1870): the Var-key translation serves from the ref
        # capture's pins, so this arms nothing; the off case uninstalls
        # the hooks so `literal_hash` never crosses into Rust.
