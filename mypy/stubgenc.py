...
class InspectionStubGenerator(BaseStubGenerator):
    ...
    def _indent_docstring(self, docstring: str) -> str:
        ...
        # if there's a trailing newline, add a final line to visually indent the quoted
        # docstring
        if lines[-1].endswith("\n"):
            if len(lines) > 1:
                lines.append(indent)
    ...
    def get_base_types(self, obj: type) -> list[str]:
        ...
        if all_bases[-1] is object:
            ...
            del all_bases[-1]
        # remove pybind11_object. All classes generated by pybind11 have pybind11_object
        # in their MRO,
