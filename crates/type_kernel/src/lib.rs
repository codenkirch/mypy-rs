...
fn type_kernel(_py: Python<'_>, module: &PyModule) -> PyResult<()> {
    ...
    module.add_function(wrap_pyfunction!(cache::rust_write_cache_meta, module)?)?;
    module.add_function(wrap_pyfunction!(cache::rust_write_cache_meta_ex, module)?)?;
    module.add_function(wrap_pyfunction!(wire::read_type_to_str, module)?)?;
    module.add_function(wrap_pyfunction!(wire::read_alias_recursion_flag, module)?)?;
    module.add_function(wrap_pyfunction!(
    ...
    module.add_function(wrap_pyfunction!(typeops::rust_get_type_vars_live, module)?)?;
    ...
    module.add_function(wrap_pyfunction!(applytype::rust_get_target_type, module)?)?;
    module.add_function(wrap_pyfunction!(
    ...
    module.add_function(wrap_pyfunction!(
        checkpattern::rust_classify_sequence_pattern_head,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
        checkpattern::rust_classify_sequence_tuple_result,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
        checkpattern::rust_classify_mapping_rest,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
        checkpattern::rust_classify_class_pattern_alias_gate,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
        checkpattern::rust_classify_class_pattern_keywords,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
        checkpattern::rust_filter_or_match_types,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
    ...
    module.add_function(wrap_pyfunction!(
        checker_functions::rust_is_definition,
        module
    )?)?;
    ...
    module.add_function(wrap_pyfunction!(
        checker_functions::rust_check_exit_return_type,
        module
    )?)?;
    ...
    module.add_function(wrap_pyfunction!(
        checker_functions::rust_is_valid_defaultdict_partial_value_type,
        module
    )?)?;
    ...
    module.add_function(wrap_pyfunction!(
        checker_functions::rust_is_noop_for_reachability,
        module
    )?)?;
    ...
    module.add_function(wrap_pyfunction!(mirror::rust_mirror_stable_alive, module)?)?;
    ...
    module.add_function(wrap_pyfunction!(
        node_mirror::rust_node_mirror_capture_meta,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
        node_mirror::rust_node_mirror_meta,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
        node_mirror::rust_node_mirror_meta_captures,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
        node_mirror::rust_node_mirror_meta_drop,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
        node_mirror::rust_node_mirror_meta_reset,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
