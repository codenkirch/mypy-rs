...
class NativeTypeResolver:
    ...
    def update(self, type_infos: list[TypeInfo], aliases: list[TypeAlias]) -> tuple[int, int]: ...
...
def rust_freshen_all_functions_type_vars(
    start_raw_id: int, type_bytes: bytes, strict_optional: bool
...
def rust_classify_declared_metaclass(
    mc_name: str | None, sym_node: Any, var_type_wire: bytes | None, meta_info: Any
) -> int | None: ...
...
def rust_create_errors(error_tuples: Any) -> Any: ...
...
def rust_instantiate_type_alias(
    node: Any, arg_blobs: Any, no_args: Any, empty_tuple_index: Any
) -> Any: ...
...
def rust_sort_within_context(errors: Any) -> Any: ...
